...
(function () {
    const chapters = [
        { h: 'chapter1.html', n: '1', t: '肺的工作原理' },
        { h: 'chapter2.html', n: '2', t: '咳嗽' },
        { h: 'chapter3.html', n: '3', t: '肺结节' },
        { h: 'chapter4.html', n: '4', t: '肺炎' },
        { h: 'chapter5.html', n: '5', t: '哮喘' },
        { h: 'chapter6.html', n: '6', t: '慢阻肺' },
        { h: 'chapter7.html', n: '7', t: '睡眠呼吸暂停' },
        { h: 'chapter8.html', n: '8', t: '肺癌' },
        { h: 'chapter9.html', n: '9', t: '保护你的肺' },
    ];
    const tools = [
        { h: 'nodule-guide.html',   i: '🔵', t: '肺结节随访指南' },
        { h: 'cough-checker.html',  i: '🔍', t: '咳嗽原因自查' },
        { h: 'lung-function.html',  i: '📈', t: '肺功能报告解读' },
    ];
    const phases = [
        { label: '🔵 呼吸基础', ids: [1,2] },
        { label: '🟢 常见疾病', ids: [3,4,5,6] },
        { label: '🟣 进阶健康', ids: [7,8,9] },
    ];

    const path = location.pathname;
    const isIndex = path.endsWith('index.html') || path.endsWith('呼吸网页/') || path.endsWith('呼吸网页');
...
<nav class="top-nav">
  <div class="top-nav-inner">
    <a href="index.html" class="logo">🫁 呼吸篇</a>
    <ul class="nav-links">
...
<aside class="nav-sidebar" id="navSidebar">
  ...
  <div class="sidebar-body">
    <a href="index.html" class="sidebar-link${activePath('index.html')}">🏠 呼吸篇首页</a>
    ${sidebarLinks}
