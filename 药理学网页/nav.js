...
(function () {
    ...
    const chapters = [
        { h: 'chapter1.html',  n: '1',  t: '药物与受体' },
        { h: 'chapter2.html',  n: '2',  t: '药动学 ADME' },
        { h: 'chapter3.html',  n: '3',  t: '药效学·治疗窗' },
        { h: 'chapter4.html',  n: '4',  t: '不良反应与耐药' },
        { h: 'chapter5.html',  n: '5',  t: '心血管药物' },
        { h: 'chapter6.html',  n: '6',  t: '呼吸系统药物' },
        { h: 'chapter7.html',  n: '7',  t: '消化系统药物' },
        { h: 'chapter8.html',  n: '8',  t: '镇痛与麻醉药' },
        { h: 'chapter9.html',  n: '9',  t: '中枢神经系统药物' },
        { h: 'chapter10.html', n: '10', t: '内分泌系统药物' },
        { h: 'chapter11.html', n: '11', t: '抗菌药物' },
        { h: 'chapter12.html', n: '12', t: '抗肿瘤药物' },
    ];

    const tools = [
        { h: 'drug-index.html',        i: '💊', t: '药物快查索引' },
        { h: 'receptor-map.html',      i: '🎯', t: '受体靶点图谱' },
        { h: 'interaction-guide.html', i: '⚠️', t: '相互作用速查' },
    ];
    ...
    /* ---- 下拉菜单：章节按3个阶段分组 ---- */
    const phases = [
        { label: '🟢 基础药理', items: chapters.slice(0, 4) },
        { label: '🟡 系统药理·循环呼消', items: chapters.slice(4, 8) },
        { label: '🔴 系统药理·神内抗菌', items: chapters.slice(8) },
    ];
